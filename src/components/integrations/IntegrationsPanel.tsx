          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {connected.map((s) => (
              <button
                key={s.id}
                onClick={() => {
                  if (s.id === 'github') setCurrentView('github');
                  else if (s.id === 'linear') setCurrentView('linear');
                  else if (s.id === 'notion') setCurrentView('notion');
                  else if (s.id === 'slack') setCurrentView('slack');
                }}
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {connected && REPLIT_CONNECTED_SERVICES.has(svc.id) && (
                          <>
                            ...
                            <button
                              onClick={() => setCurrentView(svc.id as ViewType)}
